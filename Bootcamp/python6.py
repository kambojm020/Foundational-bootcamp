...
def main():
    ...
    academic_percentage = (total_obtained / 500) * 100
    ...
    if grade != "F" and attendance_pct >= 60:
        result_status = "PASS"
    else:
        result_status = "FAIL"

    if final_performance_score >= 90 and attendance_pct >= 85:
    ...
    if academic_percentage >= 85:
        distinction_certificate = "Awarded"
    else:
        distinction_certificate = "Not Awarded"
